...
function Xp() {
  ...
  async function gd(O) {
    O.preventDefault(), k(true), I(null), $(null);
    try {
      const F = await Ae("/api/admin/users", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ username: j.username.trim(), password: j.password.trim() || void 0, trafficQuotaGb: Number(j.trafficQuotaGb || 0), maxProxyEntries: Number(j.maxProxyEntries || 10), allowedCountries: j.allowedCountries }) });
      if (!F.ok) throw new Error(F.error || "\u521B\u5EFA\u7528\u6237\u5931\u8D25");
      return R({ username: "", password: "", trafficQuotaGb: "0", maxProxyEntries: "10", allowedCountries: Pe.map((_) => _.value) }), $("\u7528\u6237\u5DF2\u521B\u5EFA\u3002\u521D\u59CB\u5BC6\u7801\u53EA\u4F1A\u663E\u793A\u8FD9\u4E00\u56DE\uFF0C\u8BF7\u73B0\u5728\u4FDD\u5B58\u3002"), await ft(), F.user && F.initialPassword ? { user: F.user, initialPassword: F.initialPassword } : null;
    } catch (F) {
  ...
  async function yd(O, F) {
    k(true), I(null), $(null);
    try {
      const _ = await Ae(`/api/admin/users/${O}`, { method: "PATCH", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ status: F.status, trafficQuotaGb: Number(F.trafficQuotaGb || 0), maxProxyEntries: Number(F.maxProxyEntries || 1), allowedCountries: F.allowedCountries }) });
  ...
  async function jd(O) {
    O.preventDefault(), k(true), I(null), $(null), qe([]);
    ...
    try {
      for (let se = 0; se < F; se += 1) {
        ...
        _.push(Re.clientProxy.copyText);
      }
      qe(_), $(`\u5DF2\u751F\u6210 ${_.length} \u6761\u4EE3\u7406${A > 0 ? `\uFF0C${A} \u6761\u56E0\u5E93\u5B58\u4E0D\u8DB3\u672A\u751F\u6210` : ""}\u3002\u5BC6\u7801\u53EA\u663E\u793A\u8FD9\u4E00\u6B21\u3002`), await ft();
    } catch (se) {
...
function nh(e) {
  var t;
  const [n, r] = C.useState(false), [a, s] = C.useState(null), [i, o] = C.useState(null), [u, f] = C.useState({ userId: "", targetCountry: "us", targetRegion: "", targetCity: "", count: "1" }), [v, p] = C.useState(null), [g, m] = C.useState({ status: "active", trafficQuotaGb: "0", maxProxyEntries: "10", allowedCountries: Pe.map((j) => j.value) }), [x, y] = C.useState(null), [L, c] = C.useState(""), [d, h] = C.useState(null), [b, S] = C.useState(((t = e.users[0]) == null ? void 0 : t.id) ?? null), [N, P] = C.useState(""), [k, V] = C.useState("all"), I = e.users.filter((j) => {
  ...
  function z(j) {
    p(j), m({ status: j.status, trafficQuotaGb: Ch(j.trafficQuotaBytes), maxProxyEntries: String(j.maxProxyEntries), allowedCountries: j.allowedCountries && j.allowedCountries.length > 0 ? j.allowedCountries : Pe.map((R) => R.value) });
  }
  function U(j) {
    y(j), c(""), h(null);
  }
...
`), `\u5DF2\u590D\u5236 ${i.copies.length} \u6761\u4EE3\u7406\uFF0C\u8BF7\u7ACB\u5373\u4FDD\u5B58\u3002`), children: "\u590D\u5236\u5168\u90E8" }) }), l.jsx("div", { className: "copy-list", children: i.copies.map((j) => {
  ...
  }) })] }), l.jsxs("div", { className: "modal-actions", children: [l.jsx("button", { type: "button", onClick: K, children: "\u53D6\u6D88" }), l.jsx("button", { className: "primary-button", type: "submit", disabled: e.isSaving || !e.userForm.username.trim() || e.userForm.allowedCountries.length < 1, children: "\u65B0\u5EFA\u7528\u6237" })] })] }) }), v && l.jsx(xr, { title: "\u7F16\u8F91\u7528\u6237\u8BBE\u7F6E", onClose: () => p(null), children: l.jsxs("form", { className: "modal-form", onSubmit: E, children: [l.jsxs("div", { className: "section-heading", children: [l.jsx("h2", { children: v.username }), l.jsx("span", { children: "\u53EA\u8C03\u6574\u666E\u901A\u7528\u6237\u7684\u542F\u7528\u72B6\u6001\u3001\u603B\u989D\u5EA6\u548C\u4EE3\u7406\u4E0A\u9650\u3002" })] }), l.jsxs("div", { className: "form-grid three", children: [l.jsxs("label", { children: ["\u72B6\u6001", l.jsx("span", { className: "field-note", children: "\u542F\u7528\u540E\u7528\u6237\u53EF\u4EE5\u6B63\u5E38\u767B\u5F55\u548C\u4F7F\u7528\uFF1B\u505C\u7528\u540E\u7528\u6237\u4E0D\u80FD\u7EE7\u7EED\u4F7F\u7528\u3002" }), l.jsxs("select", { value: g.status, onChange: (j) => m({ ...g, status: j.target.value }), children: [l.jsx("option", { value: "active", children: "\u542F\u7528" }), l.jsx("option", { value: "disabled", children: "\u505C\u7528" })] })] }), l.jsxs("label", { children: ["\u603B\u989D\u5EA6 GB", l.jsx("span", { className: "field-note", children: "\u586B 0 \u8868\u793A\u4E0D\u9650\u6D41\u91CF\uFF1B\u586B\u5176\u4ED6\u6570\u5B57\u8868\u793A\u8FD9\u4E2A\u7528\u6237\u603B\u5171\u8FD8\u80FD\u6309\u8FD9\u4E2A\u4E0A\u9650\u4F7F\u7528\u3002" }), l.jsx("input", { min: "0", step: "0.01", type: "number", value: g.trafficQuotaGb, onChange: (j) => m({ ...g, trafficQuotaGb: j.target.value }) })] }), l.jsxs("label", { children: ["\u4EE3\u7406\u4E0A\u9650", l.jsx("span", { className: "field-note", children: "\u8868\u793A\u8FD9\u4E2A\u7528\u6237\u6700\u591A\u80FD\u540C\u65F6\u4FDD\u7559\u591A\u5C11\u6761\u4EE3\u7406\u3002" }), l.jsx("input", { min: "1", max: "100", type: "number", value: g.maxProxyEntries, onChange: (j) => m({ ...g, maxProxyEntries: j.target.value }) })] })] }), l.jsxs("div", { className: "country-picker", children: [l.jsx("span", { className: "country-picker-title", children: "\u5141\u8BB8\u56FD\u5BB6" }), l.jsx("span", { className: "field-note", children: "\u81F3\u5C11\u4FDD\u7559 1 \u4E2A\u56FD\u5BB6\u3002\u8FD9\u91CC\u52FE\u9009\u54EA\u4E9B\u56FD\u5BB6\uFF0C\u7528\u6237\u7AEF\u5C31\u53EA\u80FD\u751F\u6210\u8FD9\u4E9B\u56FD\u5BB6\u7684\u4EE3\u7406\u3002" }), l.jsx("div", { className: "country-checkbox-grid", children: Pe.map((j) => {
...
function ah(e) {
  ...
  }, children: "\u67E5\u770B\u4EE3\u7406" }), l.jsx("button", { type: "button", onClick: () => e.onOpenAdminReadOnlyPage("logs", { search: e.upstream ? String(e.upstream.id) : "" }), children: "\u67E5\u770B\u65E5\u5FD7" }), l.jsx(et, { label: "\u68C0\u6D4B" }), l.jsx(et, { label: "\u7981\u7528" }), l.jsx(et, { label: "\u5220\u9664" })] })] })] }) : l.jsx(H, { title: "\u4E0A\u6E38\u8BE6\u60C5", children: l.jsx(Pt, { text: "\u8BF7\u9009\u62E9\u4E00\u6761\u4E0A\u6E38\u8D44\u6E90\u3002" }) });
}
function sh(e) {
  var t;
...
function uh(e) {
  ...
  }, children: o }), l.jsx(et, { label: "\u91CD\u7ED1" }), l.jsx(et, { label: "\u5220\u9664" })] })] })] }) : l.jsx(H, { title: "\u4EE3\u7406\u8BE6\u60C5", children: l.jsx(Pt, { text: "\u5F53\u524D\u5217\u8868\u5DF2\u53D8\u5316\uFF0C\u4F46\u8FD9\u6B21\u786E\u8BA4\u4ECD\u7136\u9501\u5B9A\u5728\u4F60\u521A\u624D\u6253\u5F00\u7684\u90A3\u6761\u4EE3\u7406\u3002" }) }), t && l.jsx(xr, { title: t.status === "disabled" ? "\u786E\u8BA4\u505C\u7528\u4EE3\u7406" : "\u786E\u8BA4\u542F\u7528\u4EE3\u7406", onClose: () => {
    n(null), a(null);
...
function fh(e) {
  var t, n;
  return l.jsxs("section", { className: "workspace", children: [l.jsxs(Jc, { label: "\u7528\u6237\u9762\u677F\u5BFC\u822A", children: [l.jsxs("div", { className: "nav-select", children: [l.jsx("span", { children: "\u5F53\u524D\u7528\u6237" }), l.jsx("strong", { children: ((t = e.selectedUser) == null ? void 0 : t.username) || "\u672A\u767B\u5F55\u7528\u6237" })] }), l.jsx(Je, { active: e.activePage === "home", onClick: () => e.setActivePage("home"), children: "\u6211\u7684\u6982\u89C8" }), l.jsx(Je, { active: e.activePage === "generate", onClick: () => e.setActivePage("generate"), children: "\u751F\u6210\u4EE3\u7406" }), l.jsx(Je, { active: e.activePage === "proxies", onClick: () => e.setActivePage("proxies"), children: "\u6211\u7684\u4EE3\u7406" }), l.jsx(Je, { active: e.activePage === "traffic", onClick: () => e.setActivePage("traffic"), children: "\u6D41\u91CF\u8BB0\u5F55" })] }), l.jsx("section", { className: "content", children: e.selectedUser ? l.jsxs(l.Fragment, { children: [e.activePage === "home" && l.jsx(ph, { user: e.selectedUser, entries: e.entries, trafficRows: e.trafficRows, onNavigate: e.setActivePage }), e.activePage === "generate" && l.jsx(hh, { allowedCountries: (n = e.selectedUser) != null && n.allowedCountries && e.selectedUser.allowedCountries.length > 0 ? Pe.filter((r) => {
    var a, s;
    return (s = (a = e.selectedUser) == null ? void 0 : a.allowedCountries) == null ? void 0 : s.includes(r.value);
  }) : Pe, copies: e.createdCopies, copyText: e.copyText, createEntries: e.createEntries, form: { ...e.form, userId: e.selectedUser.id.toString() }, isSaving: e.isSaving, setForm: e.setForm }), e.activePage === "proxies" && l.jsx(gh, { copyText: e.copyText, entries: e.entries }), e.activePage === "traffic" && l.jsx(vh, { entries: e.entries, rows: e.trafficRows })] }) : l.jsx(Pt, { text: "\u6682\u65E0\u53EF\u67E5\u770B\u7528\u6237\u3002" }) })] });
}
function ph(e) {
  const t = Number(e.user.trafficQuotaBytes), n = Number(e.user.trafficUsedBytes), r = t > 0 ? Math.max(0, t - n) : 0, a = xt(e.trafficRows.filter((o) => Hl(o.date)).map((o) => o.totalBytes)), s = xt(e.trafficRows.filter((o) => Wl(o.date)).map((o) => o.totalBytes)), i = ki(n, t);
  return l.jsxs(l.Fragment, { children: [l.jsxs("section", { className: "metric-grid", children: [l.jsx(M, { label: "\u5269\u4F59\u989D\u5EA6", value: t > 0 ? re(String(r)) : "\u4E0D\u9650", tone: t > 0 && i >= 85 ? "warn" : void 0 }), l.jsx(M, { label: "\u5DF2\u7528\u6D41\u91CF", value: re(e.user.trafficUsedBytes) }), l.jsx(M, { label: "\u4ECA\u65E5\u6D41\u91CF", value: re(String(a)) }), l.jsx(M, { label: "\u672C\u6708\u6D41\u91CF", value: re(String(s)) }), l.jsx(M, { label: "\u6211\u7684\u4EE3\u7406", value: `${e.entries.length}/${e.user.maxProxyEntries}` }), l.jsx(M, { label: "\u542F\u7528\u4EE3\u7406", value: String(e.entries.filter((o) => o.status === "active").length) })] }), l.jsxs("section", { className: "split-grid", children: [l.jsxs(H, { title: "\u989D\u5EA6", children: [l.jsxs("div", { className: "progress-block", children: [l.jsxs("div", { className: "progress-head", children: [l.jsx("span", { children: re(e.user.trafficUsedBytes) }), l.jsx("span", { children: td(e.user.trafficQuotaBytes) })] }), l.jsx("div", { className: "progress-track", children: l.jsx("span", { style: { width: `${i}%` } }) })] }), t > 0 && i >= 85 && l.jsx("div", { className: "alert-list quota-alert", children: l.jsx("span", { children: i >= 100 ? "\u989D\u5EA6\u5DF2\u7528\u5B8C\uFF0C\u8BF7\u8054\u7CFB\u7BA1\u7406\u5458\u5904\u7406\u3002" : `\u989D\u5EA6\u5DF2\u4F7F\u7528 ${i}%\uFF0C\u5EFA\u8BAE\u63D0\u524D\u8054\u7CFB\u7BA1\u7406\u5458\u3002` }) })] }), l.jsx(H, { title: "\u6700\u8FD1\u4EE3\u7406", children: e.entries.length === 0 ? l.jsx(Pt, { text: "\u6682\u65E0\u4EE3\u7406\u3002" }) : l.jsx("div", { className: "compact-list", children: e.entries.slice(0, 4).map((o) => l.jsxs("span", { children: [l.jsx("strong", { children: o.username }), l.jsx("em", { children: pe(o.targetCountry, o.targetRegion, o.targetCity) })] }, o.id)) }) })] }), l.jsx("section", { className: "split-grid", children: l.jsx(H, { title: "\u5FEB\u6377\u5165\u53E3", children: l.jsxs("div", { className: "task-list", children: [l.jsxs("button", { type: "button", onClick: () => e.onNavigate("generate"), children: [l.jsx("span", { children: "\u751F\u6210\u4EE3\u7406" }), l.jsx("strong", { children: "\u5F00\u59CB" })] }), l.jsxs("button", { type: "button", onClick: () => e.onNavigate("proxies"), children: [l.jsx("span", { children: "\u6211\u7684\u4EE3\u7406" }), l.jsx("strong", { children: e.entries.length })] }), l.jsxs("button", { type: "button", onClick: () => e.onNavigate("traffic"), children: [l.jsx("span", { children: "\u6D41\u91CF\u8BB0\u5F55" }), l.jsx("strong", { children: e.trafficRows.length })] })] }) }) })] });
}
function hh(e) {
  return C.useEffect(() => {
  ...
  }, [e.allowedCountries, e.form, e.setForm]), l.jsxs(l.Fragment, { children: [e.copies.length > 0 && l.jsxs(H, { title: "\u65B0\u751F\u6210\u4EE3\u7406", count: e.copies.length, children: [l.jsx(ji, { passwordText: "\u4EE3\u7406\u5BC6\u7801\u53EA\u663E\u793A\u8FD9\u4E00\u6B21\uFF0C\u5173\u95ED\u6216\u5237\u65B0\u540E\u4E0D\u80FD\u518D\u6B21\u67E5\u770B\u3002" }), l.jsx("div", { className: "copy-toolbar", children: l.jsx("button", { type: "button", onClick: () => e.copyText(e.copies.join(`
`), `\u5DF2\u590D\u5236 ${e.copies.length} \u6761\u4EE3\u7406\uFF0C\u8BF7\u7ACB\u5373\u4FDD\u5B58\u3002`), children: "\u590D\u5236\u5168\u90E8" }) }), l.jsx("div", { className: "copy-list", children: e.copies.map((t) => {
    const n = wi(t);
    return l.jsxs("div", { className: "copy-row", children: [l.jsxs("div", { className: "copy-content", children: [l.jsx("code", { children: t }), n && l.jsxs("div", { className: "copy-meta", children: [l.jsxs("span", { children: [l.jsx("strong", { children: "\u4E3B\u673A" }), l.jsx("code", { children: n.host })] }), l.jsxs("span", { children: [l.jsx("strong", { children: "\u7AEF\u53E3" }), l.jsx("code", { children: n.port })] }), l.jsxs("span", { children: [l.jsx("strong", { children: "\u7528\u6237\u540D" }), l.jsx("code", { children: n.username })] }), l.jsxs("span", { children: [l.jsx("strong", { children: "\u5BC6\u7801" }), l.jsx("code", { children: n.password })] })] })] }), l.jsx("button", { type: "button", onClick: () => e.copyText(t, "\u5DF2\u590D\u5236\u4EE3\u7406\uFF0C\u8BF7\u7ACB\u5373\u4FDD\u5B58\u3002"), children: "\u590D\u5236\u4EE3\u7406" })] }, t);
  }) })] }), l.jsxs("form", { className: "form-surface", onSubmit: e.createEntries, children: [l.jsxs("div", { className: "section-heading", children: [l.jsx("h2", { children: "\u751F\u6210\u4EE3\u7406" }), l.jsx("span", { children: Mn })] }), l.jsxs("div", { className: "hint-list", children: [l.jsx("span", { children: "\u751F\u6210\u540E\u4F1A\u81EA\u52A8\u7ED1\u5B9A\u53EF\u7528\u4E0A\u6E38\uFF0C\u4F46\u666E\u901A\u7528\u6237\u770B\u4E0D\u5230\u771F\u5B9E\u4E0A\u6E38\u5730\u5740\u548C\u5BC6\u7801\u3002" }), l.jsx("span", { children: "\u751F\u6210\u6210\u529F\u540E\u8BF7\u7ACB\u523B\u590D\u5236\u4FDD\u5B58\uFF0C\u7CFB\u7EDF\u4E0D\u4F1A\u957F\u671F\u4FDD\u5B58\u660E\u6587\u4EE3\u7406\u5BC6\u7801\u3002" }), l.jsx("span", { children: "\u56FD\u5BB6\u662F\u5FC5\u586B\u9879\uFF0C\u5DDE/\u5730\u533A\u548C\u57CE\u5E02\u53EF\u4EE5\u7559\u7A7A\uFF1B\u7559\u7A7A\u5C31\u53EA\u6309\u56FD\u5BB6\u8303\u56F4\u627E\u53EF\u7528\u8D44\u6E90\u3002" }), l.jsx("span", { children: "\u6570\u91CF\u8868\u793A\u4E00\u6B21\u8981\u751F\u6210\u51E0\u6761\u4EE3\u7406\uFF0C\u901A\u5E38\u586B 1 \u5C31\u591F\u4E86\uFF0C\u591A\u6761\u4F1A\u8FDE\u7EED\u521B\u5EFA\u3002" })] }), l.jsxs("div", { className: "form-grid four", children: [l.jsxs("label", { children: ["\u56FD\u5BB6", l.jsx("select", { value: e.form.targetCountry, onChange: (t) => e.setForm({ ...e.form, targetCountry: t.target.value }), children: e.allowedCountries.map((t) => l.jsx("option", { value: t.value, children: t.label }, t.value)) })] }), l.jsxs("label", { children: ["\u5DDE/\u5730\u533A", l.jsx("span", { className: "field-note", children: "\u53EF\u4E0D\u586B\uFF0C\u7559\u7A7A\u8868\u793A\u4E0D\u9650\u5236\u5DDE/\u5730\u533A\u3002" }), l.jsx("input", { value: e.form.targetRegion, onChange: (t) => e.setForm({ ...e.form, targetRegion: t.target.value }), placeholder: "\u53EF\u4E0D\u586B" })] }), l.jsxs("label", { children: ["\u57CE\u5E02", l.jsx("span", { className: "field-note", children: "\u53EF\u4E0D\u586B\uFF0C\u7559\u7A7A\u8868\u793A\u4E0D\u9650\u5236\u57CE\u5E02\u3002" }), l.jsx("input", { value: e.form.targetCity, onChange: (t) => e.setForm({ ...e.form, targetCity: t.target.value }), placeholder: "\u53EF\u4E0D\u586B" })] }), l.jsxs("label", { children: ["\u6570\u91CF", l.jsx("span", { className: "field-note", children: "\u901A\u5E38\u586B 1\uFF1B\u5982\u679C\u8981\u4E00\u6B21\u751F\u6210\u591A\u6761\uFF0C\u586B\u66F4\u5927\u7684\u6570\u5B57\u3002" }), l.jsx("input", { min: "1", max: "20", type: "number", value: e.form.count, onChange: (t) => e.setForm({ ...e.form, count: t.target.value }) })] })] }), l.jsx("button", { className: "primary-button", type: "submit", disabled: e.isSaving || !e.form.userId, children: "\u751F\u6210\u4EE3\u7406" })] })] });
}
function mh(e) {
  return C.useEffect(() => {
    e.allowedCountries.length !== 0 && (e.allowedCountries.some((t) => t.value === e.form.targetCountry) || e.setForm({ ...e.form, targetCountry: e.allowedCountries[0].value }));
...
function gh(e) {
  ...
  return l.jsxs(H, { title: "\u6211\u7684\u4EE3\u7406", count: f.length, children: [l.jsxs("div", { className: "hint-list", children: [l.jsx("span", { children: "\u5DF2\u521B\u5EFA\u4EE3\u7406\u53EA\u4FDD\u7559\u8D26\u53F7\u548C\u72B6\u6001\uFF1B\u5BC6\u7801\u53EA\u5728\u521B\u5EFA\u6210\u529F\u65F6\u663E\u793A\u4E00\u6B21\u3002" }), l.jsx("span", { children: "\u5982\u679C\u5FD8\u8BB0\u4EE3\u7406\u5BC6\u7801\uFF0C\u8BF7\u91CD\u65B0\u751F\u6210\u65B0\u4EE3\u7406\u6216\u540E\u7EED\u7531\u7BA1\u7406\u5458\u6309\u5B89\u5168\u6D41\u7A0B\u5904\u7406\u3002" }), l.jsx("span", { children: "\u641C\u7D22\u53EF\u4EE5\u8F93\u5165\u4EE3\u7406\u8D26\u53F7\u3001\u51FA\u53E3 IP \u6216\u5730\u533A\uFF1B\u72B6\u6001\u548C\u56FD\u5BB6\u7B5B\u9009\u53EF\u4EE5\u4E00\u8D77\u7528\u3002" })] }), l.jsxs("div", { className: "table-tools", children: [l.jsxs("label", { children: ["\u641C\u7D22", l.jsx("input", { value: t, onChange: (p) => n(p.target.value), placeholder: "\u4EE3\u7406\u8D26\u53F7\u3001\u51FA\u53E3 IP\u3001\u5730\u533A" })] }), l.jsxs("label", { children: ["\u72B6\u6001", l.jsxs("select", { value: r, onChange: (p) => a(p.target.value), children: [l.jsx("option", { value: "all", children: "\u5168\u90E8\u72B6\u6001" }), l.jsx("option", { value: "active", children: "\u542F\u7528" }), l.jsx("option", { value: "disabled", children: "\u505C\u7528" }), l.jsx("option", { value: "dead", children: "\u5931\u6548" })] })] }), l.jsxs("label", { children: ["\u56FD\u5BB6", l.jsxs("select", { value: s, onChange: (p) => i(p.target.value), children: [l.jsx("option", { value: "all", children: "\u5168\u90E8\u56FD\u5BB6" }), u.map((p) => l.jsx("option", { value: p, children: p.toUpperCase() }, p))] })] }), o && l.jsx("button", { type: "button", onClick: () => {
    n(""), a("all"), i("all");
...
function vh(e) {
  ...
  return l.jsxs(l.Fragment, { children: [l.jsxs("section", { className: "metric-grid compact", children: [l.jsx(M, { label: "\u4ECA\u65E5\u6D41\u91CF", value: re(String(t)) }), l.jsx(M, { label: "\u672C\u6708\u6D41\u91CF", value: re(String(n)) }), l.jsx(M, { label: "\u6709\u8BB0\u5F55\u4EE3\u7406", value: String(new Set(e.rows.map((m) => m.proxyEntryId)).size) }), l.jsx(M, { label: "\u8FDE\u63A5\u6B21\u6570", value: String(e.rows.reduce((m, x) => m + x.connections, 0)) }), l.jsx(M, { label: "\u4EE3\u7406\u6570\u91CF", value: String(e.entries.length) })] }), l.jsxs(H, { title: "\u6BCF\u6761\u4EE3\u7406\u7528\u91CF", count: f.length, children: [l.jsx("div", { className: "hint-list", children: l.jsx("span", { children: "\u641C\u7D22\u53EF\u4EE5\u8F93\u5165\u4EE3\u7406\u8D26\u53F7\u3001\u65E5\u671F\u6216\u5730\u533A\uFF1B\u65E5\u671F\u7B5B\u9009\u53EF\u4EE5\u53EA\u770B\u4ECA\u5929\u6216\u672C\u6708\u3002" }) }), l.jsxs("div", { className: "table-tools", children: [l.jsxs("label", { children: ["\u641C\u7D22", l.jsx("input", { value: r, onChange: (m) => a(m.target.value), placeholder: "\u4EE3\u7406\u8D26\u53F7\u3001\u65E5\u671F\u3001\u5730\u533A" })] }), l.jsxs("label", { children: ["\u65E5\u671F", l.jsxs("select", { value: s, onChange: (m) => i(m.target.value), children: [l.jsx("option", { value: "all", children: "\u5168\u90E8\u65E5\u671F" }), l.jsx("option", { value: "today", children: "\u4ECA\u5929" }), l.jsx("option", { value: "month", children: "\u672C\u6708" })] })] }), g && l.jsx("button", { type: "button", onClick: () => {
    a(""), i("all");
